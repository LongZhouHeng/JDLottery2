...
public class AliplayPayAPI extends BasicRequest {


    private final BasicResponse.RequestListener mListener;
    private PayMentBean model;
    private String uid;
    private String order_des;//订单描述
    private String order_title;//订单标题
    private String order_payamount;
    private String allow_latertime;
    public AliplayPayAPI(Activity activity, String uid, String order_des, String order_title, String order_payamount,
    ...
    public void onSucceed(int what, Response<String> response) {
        try {
            ...
            model = JSON.parseObject(response.get(), PayMentBean.class);
            if (model.msg.equals("success")) {
                mListener.onComplete(new BasicResponse<PayMentBean>(model));
