...
public class Already115API extends BasicRequest {
    ...
    public Already115API(Activity activity, String table_name, int PageNum, String PageSize, RequestListener mListener) {
