...
public class New115OpenAPI extends BasicRequest {
    ...
    private String  uid ;
    public New115OpenAPI(Activity activity,String uid, String table_name, int PageNum, String PageSize, RequestListener mListener) {
