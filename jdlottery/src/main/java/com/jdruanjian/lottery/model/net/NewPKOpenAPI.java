...
public class NewPKOpenAPI extends BasicRequest {
    ...
    private String uid ;
    public NewPKOpenAPI(Activity activity,String uid, String table_name,int PageNum, String PageSize, RequestListener mListener) {
...
//        System.out.println("CCCCCCCCCCCC"+PageSize);
    ...
    public void onSucceed(int what, Response<String> response) {
        try {
            ...
            model = JSON.parseObject(response.get(), AllPKLotModel.class);
            System.out.println("BBBBBBBBBBBB"+model);
            if (model.msg.equals("success")) {
                mListener.onComplete(new BasicResponse<AllPKLotModel>(model));
            } else {
