...
public class Fragment_myteam2 extends BaseFragment {

    @BindView(R.id.spend_total)
    TextView spendTotal;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View layout = myInflater.inflate(R.layout.fragment_myteam2, container, false);
        unbinder = ButterKnife.bind(this, layout);
     //   getOrder();
        Bundle bundle = getActivity().getIntent().getExtras();
        spendTotal.setText(bundle.getString("mon"));
        return layout;
    }
            ...
            public void onComplete(BasicResponse response) {
                if (response.error == BasicResponse.SUCCESS) {
                    ...
                    if (orderTotalBean.msgContext.equals("datasSuc")) {
                        spendTotal.setText(orderTotalBean.money);
                    }
                } else {
                    orderTotalBean = (OrderTotalBean) response.model;
